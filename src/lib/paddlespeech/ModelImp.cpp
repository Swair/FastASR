...
void ModelImp::hyps_process(deque<PathProb> hyps, Tensor<float> *din,
...
void ModelImp::calc_score(deque<PathProb> hyps, Tensor<float> *decoder_out,
                          Tensor<float> *scorce)
{
...
void ModelImp::loadparams(const char *filename)
{
